...
import { ArrowRight, Headphones, ListOrdered, Sigma, Sparkles, Users } from 'lucide-react'
...
export default function SalesMasterclass() {
  ...
  return (
    <main className="bg-[#FAFBFC] min-h-screen overflow-x-hidden">
      ...
      {/* Knowledge/Systems/Tools entry cards removed — they duplicated the
          NavCards section above. The "Start here" strip (under Hero) and
          NavCards already cover all three destinations. */}
