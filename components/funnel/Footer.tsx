        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 mb-12 pb-12 border-b border-white/10">
          ...
          <div>
            ...
            <ul className="space-y-1">
              ...
              <li>
                <a href="tel:+447771775917" className="flex items-center gap-2 text-white/50 hover:text-[#E8192C] text-sm transition-colors py-2 min-h-[44px]">
                  <Phone className="w-4 h-4 flex-shrink-0" />
                  +44 7771 775917
                </a>
              </li>
              <li className="flex items-center gap-2 text-white/50 text-sm py-2 min-h-[44px]">
