      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 mb-12 pb-12 border-b border-white/10">
          ...
          <div>
            ...
            <ul className="space-y-1">
              <li>
                <a href="mailto:keilan.jd@etotomedia.com" className="flex items-center gap-2 text-white/50 hover:text-[#E8192C] text-sm transition-colors py-2 min-h-[44px]">
                  <Mail className="w-4 h-4 flex-shrink-0" />
                  keilan.jd@etotomedia.com
                </a>
              </li>
              <li>
                <a href="tel:01420463330" className="flex items-center gap-2 text-white/50 hover:text-[#E8192C] text-sm transition-colors py-2 min-h-[44px]">
                  <Phone className="w-4 h-4 flex-shrink-0" />
                  01420 463330
                </a>
              </li>
              <li className="flex items-start gap-2 text-white/50 text-sm py-2 min-h-[44px]">
                <MapPin className="w-4 h-4 flex-shrink-0 mt-0.5" />
                <span>Unit 14, Coxbridge Business Park, Alton Rd, Farnham GU10 5EH</span>
              </li>
            </ul>
          </div>
          <div>
            ...
            <ul className="space-y-1">
              <li>
                <a href="https://etotomedia.com" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-white/50 hover:text-[#E8192C] text-sm transition-colors py-2 min-h-[44px]">
                  <ExternalLink className="w-4 h-4 flex-shrink-0" />
                  etotomedia.com
                </a>
              </li>
              <li>
                <a href="https://chat.whatsapp.com/FSM9iEeKpPj9Oux4qYyFSz?mode=gi_t" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-white/50 hover:text-[#25D366] text-sm transition-colors py-2 min-h-[44px]">
              ...
              <li>
                <a href={googleReviewsUrl} target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-yellow-400 hover:text-yellow-300 text-sm font-medium transition-colors py-2 min-h-[44px]">
        ...
        <div className="flex flex-wrap items-center justify-center gap-6 mb-8 text-white/30 text-xs">
          <span className="flex items-center gap-1.5">
            ...
            £200M+ Sales for Clients
          </span>
          <span className="flex items-center gap-1.5">
            <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6" /></svg>
            £5M/Month Avg Client Sales
          </span>
          <span className="flex items-center gap-1.5">
